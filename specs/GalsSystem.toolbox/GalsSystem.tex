...
\fl{}\moduleLeftDash\cl{ {\MODULE} GalsSystem}\moduleRightDash\cl{}
\fl{ {\EXTENDS} FiniteSets ,\, Naturals}
\fl{}
\fl{ {\CONSTANTS}}\al{3}{1}{ CELLS ,\,}\al{3}{3}{%
\@y{\@s{0}%
 A set of cells
}%
}
\fl{ NEIGHBOURS ,\,}\al{4}{2}{%
\@y{\@s{0}%
 A record with each cell being a field
}%
}
\fl{}\al{5}{0}{}
\fl{ MAXTIME}\al{6}{1}{%
\@y{\@s{0}%
 Maximum time for the systems
}%
}
\fl{}
\fl{ {\VARIABLES} state}\al{8}{2}{%
\@y{\@s{0}%
 A function with domain the set of cells
}%
}
\fl{}\al{9}{0}{}
\fl{}
\fl{}
\fl{ NeighbourOK \.{\defeq} \A\, c}\al{12}{4}{ \.{\in} CELLS \.{:}}
\fl{ \A\, n \.{\in} NEIGHBOURS . c \.{:} c \.{\in} NEIGHBOURS . n}
\fl{}
\fl{}
\fl{ TimeDiffOK \.{\defeq} \A\, c}\al{16}{4}{ \.{\in} CELLS \.{:}}
\fl{ \A\, n}\al{17}{2}{ \.{\in} NEIGHBOURS . c \.{:}}
 \fl{ \.{\land}}\al{18}{1}{ state . c . t}\al{18}{6}{ \.{-}}\al{18}{7}{ state
 . n . t}\al{18}{12}{ \.{<}}\al{18}{13}{ 2}
 \fl{ \.{\land}}\al{19}{1}{ state . c . t}\al{19}{6}{ \.{-}}\al{19}{7}{ state
 . n . t}\al{19}{12}{ \.{>}}\al{19}{13}{ 0 \.{-} 2}
\fl{}
 \fl{ TypeOK \.{\defeq}}\al{21}{2}{ \.{\land}}\al{21}{3}{ \A\, c}\al{21}{5}{
 \.{\in} CELLS \.{:}}
\fl{ \.{\land}}\al{22}{1}{ state . c . t \.{\leq} MAXTIME}
 \fl{ \.{\land}}\al{23}{1}{ state . c . cs}\al{23}{6}{ \.{\leq}}\al{23}{7}{
 Cardinality ( NEIGHBOURS . c )}
 \fl{ \.{\land}}\al{24}{1}{ state . c . ns}\al{24}{6}{ \.{\leq}}\al{24}{7}{
 Cardinality ( NEIGHBOURS . c )}
\fl{ \.{\land}}\al{25}{1}{ NeighbourOK}
\fl{ \.{\land}}\al{26}{1}{ TimeDiffOK}
\fl{}
 \fl{ GSInit \.{\defeq} state \.{=}}\al{28}{4}{ [ c \.{\in} CELLS}\al{28}{8}{
 \.{\mapsto}}
 \fl{ [ t \.{\mapsto} 0 ,\, cs}\al{29}{6}{ \.{\mapsto} Cardinality (
 NEIGHBOURS . c ) ,\, ns \.{\mapsto} 0 ] ]}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ Send ( c ) \.{\defeq}}\al{36}{5}{%
\@y{\@s{0}%
 Check if the cell is blocked
}%
}
\fl{ \.{\land} state [ c ] . cs \.{=} Cardinality ( NEIGHBOURS . c )}
\fl{}
\fl{ \.{\land} state [ c ] . t \.{<} MAXTIME}
\fl{}
 \fl{ \.{\land} [ state {\EXCEPT} {\bang} [ c ] . t \.{=} 1 \.{+} @ ,\,
 {\bang} [ c ] . cs \.{=} state . c . ns ,\, {\bang} [ c ] . ns \.{=} 0 ]}
\fl{}
\fl{ \.{\land} \A\, n}\al{43}{3}{ \.{\in} NEIGHBOURS . c \.{:}}
 \fl{ {\IF}}\al{44}{1}{ state [ n ] . t \.{=} state [ n ] . t \.{+} 1
 \.{\THEN}}
\fl{ [ state {\EXCEPT} {\bang} [ n ] . cs \.{=} @ \.{+} 1 ]}
\fl{ \.{\ELSE} [ state {\EXCEPT} {\bang} [ n ] . ns \.{=} @ \.{+} 1 ]}
\fl{}
 \fl{ GSNext}\al{48}{1}{ \.{\defeq}}\al{48}{2}{ \E\, c \.{\in} CELLS \.{:}
 Send ( c )}
\fl{}
 \fl{ GSSpec}\al{50}{1}{ \.{\defeq}}\al{50}{2}{ GSInit \.{\land} {\Box} [
 GSNext ]_{ {\langle} state {\rangle}}}
\fl{}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
