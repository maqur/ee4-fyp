...
VARIABLES   state       \* A record with each cells as a fields whose 
...
GSInit  ==  state = [c \in CELLS |-> [t: 0, cs: Cardinality(NEIGHBOURS[c]), ns: 0]]  
...
\* Last modified Thu Jan 11 11:56:45 GMT 2018 by affan
